            ...
            {canFinance && finalInvoice.approved && (finalInvoice.grandTotal - finalInvoice.amountPaid) > 0 && (
              <div className="flex items-end gap-3 border-t border-line-soft pt-4">
                ...
                <Button onClick={() => {
                  ...
                  recordPayment.mutate({ invoiceId: finalInvoice._id, amount: bal, method: method as any }, { onSuccess: () => { toast.success('Payment recorded.'); invalidate() }, onError: (e: any) => toast.error(e.message) })
