...
var ENCODED_SEP_RE_G = /* @__PURE__ */ new RegExp(ENCODED_SEP_RE.source, "gi");
...
//#endregion
export { FastURL, H3Core, HTTPError, NodeResponse, NullProtoObj, defineHandler, defineLazyEventHandler, resolveDotSegments, serve, toEventHandler, toRequest };
